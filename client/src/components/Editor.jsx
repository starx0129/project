...
const Editor = () => {
  ...
  const checkSpelling = async () => {
    try {
      const response = await axios.post("http://localhost:5000/api/spellcheck", {
        text,
      });
  ...
  const checkGrammar = async () => {
    try {
      const response = await axios.post("http://localhost:5000/api/grammarcheck", {
        text,
      });
      console.log(response.data);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          ...
          <div className="flex justify-between">
            <button className="py-2 px-4 bg-blue-500 text-white rounded-xl ">Casual</button>
            <button  className="py-2 px-4 bg-blue-500 text-white rounded-xl ">Standard</button>
            <button  className="py-2 px-4 bg-blue-500 text-white rounded-xl ">Professional</button>
          </div>
        </div>
